    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold">Discover Delicious Food Adventures</h2>
          <p className="text-gray-600">Explore the world of flavors with TasteTrek</p>
        </div>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-3 gap-4">
              {featuredCategories.map(category => (
                <div key={category.idCategory} className="border border-gray-300 rounded-md p-4">
                  <h3 className="text-xl font-semibold">{category.strCategory}</h3>
                  <p className="text-gray-600">{category.strCategoryDescription}</p>
                </div>
              ))}
            </div>
          )}
      ...
      <footer className="bg-gray-800 text-white text-center py-4">
        <div className="container mx-auto px-4">
          <p className="text-gray-400">© 2024 TasteTrek. All rights reserved.</p>
